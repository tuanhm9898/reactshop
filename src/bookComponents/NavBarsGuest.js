        ...
        <div>
            <Navbar bg="light" expand="lg" fixed="top" className="m-0 p-0">
                <Container className="my-0 p-0">
                    <Navbar.Brand><Link to="/login" className="nav-link">
                        <img src={logo} height="65"/>
                    </Link></Navbar.Brand>
                    <Navbar.Toggle aria-controls="basic-navbar-nav"/>
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="me-auto"  style={{display:'flex',alignItems: 'center'}}>
                            <Nav.Link><Link to="/login" className="nav-link">Home</Link></Nav.Link>
                            <Nav.Link><Link to="/login" className="nav-link">Book Like</Link></Nav.Link>
                            {/*<Nav.Link><Link to="/login"="/admin" className="nav-link">Admin</Link></Nav.Link>*/}
                            <Nav.Link><Link to="/login" className="nav-link">
